import { Title, DeleteConfirm, SelectLib } from "@/components";
import {
  BsFillPersonFill,
  BsPencilSquare,
  BsFillTrashFill,
...
import {
  getHouseBySearchCondition,
  getHouseById,
  addHouse,
  updateHouse,
  deleteHouse,
} from "@/apis/supperAdmin/house/house";
import {
  getRoomById,
  addRoom,
  updateRoom,
  deleteRoom,
} from "@/apis/supperAdmin/room/room";
import {
  getTenantById,
  addTenant,
  updateTenant,
  ...
  moveTenant,
  deleteTenant,
} from "@/apis/supperAdmin/tenant/tenant";
import {
  getCities,
  getWardesByDistrictId,
  getDistrictesByCityId,
} from "@/apis/common";
...
const ManagerHouse = () => {
  ...
  const handleSearchRoom = () => {
    ...
    getHouseBySearchCondition(queryString)
      .then((response) => {
        // Handle the response data here
        setHouseData(response);
        setCurrentHouseId(
          currentHouseId ? currentHouseId : response[0].houseId
        );
  ...
  const validateHouse = () => {
    const newValidity = {
      houseName:
        formHouse.houseName !== null && formHouse.houseName.trim() !== "",
  ...
  const validateRoom = () => {
    const newValidity = {
      ...
      electricityPrice:
        formRoom.electricityPrice !== null && formRoom.electricityPrice != 0,
  ...
  const validateTenant = () => {
    const newValidity = {
      ...
      phoneNumber:
        formTenant.phoneNumber !== null && formTenant.phoneNumber.trim() !== "",
      identifier:
        formTenant.identifier !== null && formTenant.identifier.trim() !== "",
  ...
  const handleSubmitRoom = (e) => {
    ...
    if (validateRoom()) {
      if (formRoom.id != "") {
        // edit
        updateRoom(formRoom.id, formRoom)
          .then((response) => {
            if (!response.success) {
  ...
  const handleSubmitHouse = (e) => {
    ...
    if (validateHouse()) {
      if (formHouse.houseId != "") {
        ...
        updateHouse(formHouse.houseId, formHouse)
          .then((response) => {
            // Handle the response data here
  ...
  const handleSubmitTenant = (e) => {
    ...
    if (validateTenant()) {
      if (formTenant.id != "") {
        // edit
        updateTenant(formTenant.id, formTenant)
          .then((response) => {
            // Handle the response data here
            if (!response.success) {
              toast.error(response.message);
  ...
  const handleCheckboxMoveTenantChange = (event) => {
    ...
    if (event.target.checked) {
      ...
      setCheckedMoveTenantIds((prevIds) =>
  ...
  const confirmDelete = (status, type) => {
    if (status) {
      ...
      if (type.type == "room") {
        ...
        if (checkedMoveTenantIds && checkedMoveTenantIds.length > 0) {
          deleteTenant(checkedMoveTenantIds)
            .then((response) => {
              if (!response.success) {
                toast.error(response.message);
              } else {
      ...
      <div>
        <div>
            ...
            <form className="flex" onSubmit={handleSubmitSearch}>
              <div className="flex">
                <div className="flex mx-2 self-center">
                  <label
                    htmlFor="price"
                    className="text-sm font-medium text-black self-center mr-4"
                  >
                    Giá :
                  </label>
                  <input
              ...
              <button
                className="font-bold cursor-pointer px-5 py-2 mr-3 inline text-sm font-medium text-center text-white rounded-lg bg-[#03c6fc] hover:bg-[#03a5fc]"
                onClick={() => {
              ...
              <button
                type="submit"
                className="font-bold cursor-pointer px-5 py-2 mr-3 inline text-sm font-medium text-center text-white rounded-lg bg-[#26B99A] hover:bg-green-800"
              >
                Tìm kiếm
              </button>
            </form>
          ...
          <div className="flex justify-center">
            <div className=" border-b border-[#0000003b] m-2 mx-6 w-4/5"></div>
          </div>
          {/* body data list */}
              ...
              {houseData &&
                ...
                houseData.map((el) => (
                  <Fragment key={el.houseId}>
                    <li
                      className={
                        currentHouseId == el.houseId
                          ? "font-bold cursor-pointer py-2 px-2 mx-2 inline border-b-4 border-r-2 border-l-2 border-[#059669] shadow-md shadow-[#26B99A]"
                          : "cursor-pointer  py-2  px-2 mx-2 inline hover:border-b-4 hover:border-[#059669] hover:shadow-md hover:shadow-[#26B99A]"
                      }
                      onClick={() => {
            ...
            <ul className="self-center ">
              ...
              >
                <button className="flex inline-flex items-center px-4 font-bold cursor-pointer px-5 mx-2 py-3 inline text-sm font-medium text-center text-white rounded-lg bg-[#26B99A] hover:bg-green-800">
                  Thêm phòng{" "}
                  <BsFillPatchPlusFill size={15} className="inline ml-3" />
                </button>
              </li>
              <li
                className="inline"
              ...
              >
                <button
                  className={`${isLoadingHouseAPI ? "pointer-events-none opacity-50" : ""} flex inline-flex items-center px-4 font-bold cursor-pointer px-5 mx-2 py-3 inline text-sm font-medium text-center text-white rounded-lg bg-blue-500 hover:bg-blue-800`}
                >
                  Thêm nhà{" "}
                  <BsFillHouseAddFill size={15} className="inline ml-3" />
                </button>
              </li>
              <li
                className="inline"
              ...
              <li
                ...
                onClick={() => {
                  ...
                  setmessageDelete(
                    "Xóa nhà này sẽ xóa tất cả thông tin liên quan đến nhà này bạn có muốn tiếp tục ?"
                  );
                          ...
                          <Fragment key={r.id}>
                            <div className="flex flex-col max-w-sm p-5 bg-white border rounded-lg border-[#059669] shadow-md shadow-[#26B99A]">
                              ...
                              <div className="text-black py-1">
                                <span className="font-bold px-2">Giá :</span>{" "}
                              ...
                              <button
                                className="flex justify-between inline-flex items-center mt-3 px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                onClick={() => {
                              ...
                              <div className="flex">
                                <button
                                  className="mt-10 mr-3 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800"
                                  onClick={() => {
                                ...
                                <button
                                  className="mt-10 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-[red] hover:bg-red-800"
                                  onClick={() => {
                                    setTypeDelete({
                                      type: "room",
                                      id: r.id,
              ...
              <div className="relative bg-white rounded-lg shadow shadow-black">
                ...
                <div className="flex items-center justify-between py-5 mx-4 border-b border-[#0000002e] rounded-t">
                  ...
                  <button
                    ...
                    type="button"
                    className="text-black bg-transparent hover:bg-gray-200 hover:text-black rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                ...
                <form onSubmit={handleSubmitRoom} className="p-4 md:p-5">
                  <div className="grid grid-rows- gap-4">
                    ...
                    <div className="grid grid-cols-5 gap-4">
                      <div className="col-span-2">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium text-black"
                        >
                          Giá điện <span className="text-[#EF444A]">*</span>
                        </label>
                        <input
                          type="number"
                          ...
                          required=""
                          value={formRoom.electricityPrice}
                          onClick={handleInputRoomChange}
                          onChange={handleInputRoomChange}
                        />
                      </div>
                      <div className="col-span-2">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium text-black"
                        >
                          Giá nước <span className="text-[#EF444A]">*</span>
                        </label>
                        <input
                          type="number"
                          name="waterPrice"
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      <div className="col-span-3">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium text-black"
                        >
                          Giá phòng <span className="text-[#EF444A]">*</span>
                        </label>
                        <input
                          type="number"
                          name="price"
                      ...
                      <div className="col-span-1">
                        ...
                        >
                          Số lượng max <span className="text-[#EF444A]">*</span>
                        </label>
                        <input
                          type="number"
                          name="stayMax"
                    ...
                    <div className="grid grid-cols-4 gap-4 ">
                      <div className="col-span-1">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium text-black"
                        >
                          Diện tích <span className="text-[#EF444A]">*</span>
                        </label>
                        <input
                          type="number"
                          name="acreage"
                      ...
                      <div
                        className={
                          statusModalRoom
                            ? "col-start-4 pointer-events-none opacity-25"
                            : "col-start-4"
                        }
                      >
                        <label
                    ...
                    <span className="text-[#EF444A] text-sm">
                      (*) Hạng mục bắt buộc
                    </span>
                  </div>
                  {statusModalRoom ? (
                    <button
                      type="submit"
                      className="mt-10 text-white inline-flex items-center bg-[#26B99A] hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                    >
                      <svg
                  ...
                  <div className="grid grid-rows- gap-4">
                    <div className="grid grid-cols-4 gap-4">
                      <div className="col-span-2">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium text-black "
                        >
                          Tên nhà <span className="text-[#EF444A]">*</span>
                        </label>
                        <input
                          type="text"
                          name="houseName"
                      ...
                      <div className="col-span-2">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium text-black "
                        >
                          Thành phố <span className="text-[#EF444A]">*</span>
                        </label>
                        <select
                          id="category"
                          className="bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-black-500 focus:border-black block w-full p-2.5 dark:placeholder-gray-400 "
                          value={currentCityId}
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      <div className="col-span-2">
                        ...
                        >
                          Quận / Huyện{" "}
                          <span className="text-[#EF444A]">*</span>{" "}
                        </label>
                        <select
                          id="district"
                          className="bg-white border border-gray-300 text-black text-sm rounded-lg focus:border-black-500 block w-full p-2.5 dark:placeholder-gray-400"
                      ...
                      <div className="col-span-2">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium text-black "
                        >
                          Phường <span className="text-[#EF444A]">*</span>
                        </label>
                        <select
                          id="ward"
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      <div className="col-span-4">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium text-black "
                        >
                          Địa chỉ <span className="text-[#EF444A]">*</span>
                        </label>
                        <input
                          type="text"
                          name="address"
                    ...
                    <div className="pb-4 bg-white dark:bg-white-900 px-4 py-4">
                      <div className="flex justify-between items-wrap bg-white dark:bg-white-900">
                        ...
                        <div className="my-2 text-lg font-semibold self-center">
                          ...
                          <select
                            className=" ml-4 bg-white border border-gray-300 text-black text-center text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 py-2 px-4 dark:border-gray-500 dark:placeholder-gray-400 dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <ul className="my-2 self-center">
                          <li
                            className={
                              currentRoomId
                                ? "inline"
                                : "inline pointer-events-none opacity-50"
                            }
                            onClick={() => {
                          ...
                          >
                            <button
                              className={`flex inline-flex items-center px-4 font-bold cursor-pointer px-5 mx-2 py-3 inline text-sm font-medium text-center text-white rounded-lg bg-[#26B99A] hover:bg-green-800`}
                            >
                          ...
                          >
                            <button
                              className={`flex inline-flex items-center px-4 font-bold cursor-pointer px-5 mx-2 py-3 inline text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-900`}
                            >
                              Di chuyển khách đến phòng
                              <BsPencilSquare
                                size={15}
                                className="ml-1 inline"
                              />
                          ...
                          <li
                            ...
                            onClick={() => {
                              ...
                              setmessageDelete(
                                "Bạn có chắc muốn xóa những khách đã chọn khỏi phòng này ?"
                              );
                              setshowModalDelete(true);
                            }}
                          >
                          ...
                          tenantData.map((tenant) => (
                            <Fragment key={tenant.id}>
                              <tr className="bg-white hover:bg-[#0000000d] border-b border-gray-400">
                                <td className="w-4 p-4">
                                  <div className="flex items-center">
                                    <input
                                      ...
                                      checked={checkedMoveTenantIds.includes(
                                        tenant.id
                                      )}
                                    />
                                    <label
                                ...
                                <td className="px-2 py-3">{tenant.age}</td>
                                <td className="px-2 py-3">{tenant.gender}</td>
            ...
            <div className="w-1/4 p-4">
              ...
              <div className="w-full bg-white rounded-lg shadow shadow-black">
                ...
                <div className="w-full p-4 md:p-5">
                  ...
                  >
                    Di chuyển{" "}
                    <BsArrowLeftRight size={15} className="inline ml-3" />
                  </button>
                </div>
              </div>
            </div>
                    ...
                    <div className="grid grid-cols-5 gap-4">
                      <div className="col-span-2">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium text-black"
                        >
                          Tên khách ở <span className="text-[#EF444A]">*</span>
                        </label>
                        <input
                          type="text"
                          name="name"
                      ...
                      <div className="col-span-2">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium text-black"
                        >
                          CCCD khách ở <span className="text-[#EF444A]">*</span>
                        </label>
                        <input
                          type="text"
                          name="identifier"
                    ...
                    <div className="grid grid-cols-5 gap-4">
                      ...
                      <div className="col-span-2">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium text-black"
                        >
                          SĐT khách ở <span className="text-[#EF444A]">*</span>
                        </label>
                        <input
                          type="text"
                          name="phoneNumber"
                    ...
                    <div className="flex grid-cols-5 gap-4 ">
                      <div className="col-span-1">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium text-black"
                        >
                          Tuổi khách ở <span className="text-[#EF444A]">*</span>
                        </label>
                        <input
                          type="number"
                          name="age"
